...
def main():
    ...
    if menu == 'Home':
        st.subheader('Home')
        st.write('Welcome to the Traffic Prediction App.')
        ...
        selected_time_str = st.text_input('Enter timein HH:MM'  , value='12:00', key="time_input")

        # Parse the time input
        selected_time = parse_time(selected_time_str)
